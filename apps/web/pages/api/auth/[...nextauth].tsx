...
const providers: Provider[] = [
  CredentialsProvider({
    ...
    async authorize(credentials) {
      ...
      console.log("TESTTT:isCorrectPassword");
...
console.log("TESTTT:calcomAdapter");
export default NextAuth({
  ...
  callbacks: {
    ...
    async session({ session, token }) {
      console.log("TESTTT:session" + JSON.stringify(session) + JSON.stringify(token));
